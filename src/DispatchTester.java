...
public class DispatchTester {
  ...
  public static void main(String[] args) {
    ...
    /**
     * while or for w/counter(i!=0, 1++){ choose truck to update info 123 if statements } add choose
     * 4 to return top of menu
     */
    int choice = 1;
    while (choice != 4 && choice >= 1) {
      ...
      /**
       * else if(choice != (1|2|3|4)){ System.out.println("Error: Invalid Option\n Enter 1-4");
       * break; }
       */
      else if (choice == 4) {
        break;
